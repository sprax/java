...
*/
    ...
    /**
     * Construct new graph with no edges.  Any vertices in verts will be
     add3ed.
    */
    ...
    */
    ...
    /**
     * Add an edge by specifying two vertices.  If a vertex is not already in
     the graph, it too is
     * added.
     *
     * @param vertA
    ...
    */
     ...
     * Breadth-first search for a path from start vertex to end vertex.
     If found, the first such
     * path is placed in the path argument (a vector of vertices),
     and the function returns true.  If
     * no such path is found, the functions returns false,
     and the supplied path will be empty.
     *
