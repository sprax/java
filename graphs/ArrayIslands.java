...
/**
 * Given a matrix containing 0 and 1.  Consider 1 as 'Land' and 0 as 'Water'.
 Find out the number of
 * 'Islands' in the matrix.  That is, set of all adjacent 1 will make up for an
 island.
 *
 * For example:
 *
 ...
 *
 * This problem has 4 islands. ( consider set of 1s, vertically,
 horizontally and diagonally ).
 *
 * Note: Classify this as a graph problem, not an array problem,
 because the initial array is used
 * only to specify a graph; the graph does not cover the whole array.
...
public class ArrayIslands
{
    ...
    /**
     * Constructor uses BFS to build a minimal graph, counting the connected
