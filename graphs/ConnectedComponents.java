...
public class ConnectedComponents<V extends Vertex>
{
     ...
     * connected component; the <em>count</em> operation determines the number of connected
     * components; and the <em>size</em> operation determines the number of vertices in the connect
     * component containing a given vertex.
     * 
     * The <em>component identifier</em> of a connected component is one of the vertices in the
     * connected component: two vertices have the same component identifier if and only if they are
     ...
     * <p>
     * For additional documentation, see <a href="/algs4/41graph">Section 4.1</a> of <i>Algorithms,
