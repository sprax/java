...
public class ElevatorSwitch
{
    ...
    // constructor
    public ElevatorSwitch(String name, int numFloors, long periodMs) 
    {
        if (name != null)
            mName = name;
        else
    ...
    {    
        private final ElevatorSwitch mElevator;
        
        UpdateTask(ElevatorSwitch elevator) {
            mElevator = elevator;
        }
    ...
    {
        String testName = ElevatorSwitch.class.getName() + ".unit_test";
        Sx.puts(testName + " BEGIN");  
        int stat = 0;
        
        Random rng = new Random();
        if (level > 0) {
            ElevatorSwitch elevator = new ElevatorSwitch("El Ten", 10, 101);
            elevator.mVerbose = 2;
            ...
            // Both of these ways of running the update lool run and exit cleanly.
