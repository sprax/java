...
public class Median
{
     ...
     * The interval starts at index <code>from</code> and goes to <code>to</code>; the values at
     * these positions are included.
     * Note that the array will be modified while searching, so you might want
     * to backup your data.
     * <p>
     * This implementation is a port of the C function from <code>quickselect.c</code>, provided at
     * <a target="_top" href="http://ndevilla.free.fr/median/">http://ndevilla.free.fr/median/</a>.
     * The page is a good resource for various median value algorithms, including implementations
     * and benchmarks.
     * <p>
     * The original code on which this class is based was written in C++ by Martin Leese. It was
     * ported to C and optimized by Nicolas Devillard (author of the above mentioned page). The
     * algorithm is from <em>Numerical recipes in C</em>, Second Edition, Cambridge University
