...
import java.awt.geom.Point2D;	// TODO: make AWT work here
...
public class AStarPathAwt
{
    ...
    /** Ctor */
    public AStarPathAwt(Point2D r0, Point2D r1, Point2D sensorPoints[], double sensorRadius) 
    {
        corner0 = r0;
        corner1 = r1;
    ...
    {
        String testName = AStarPathAwt.class.getName() + ".unit_test";
        Sx.format("BEGIN %s\n", testName);
        int numWrong = 0;
        ...
        Sx.printArrayFolded(acir.minimalCoordPath, 5, AStarPathAwt::printOnePoint2d);
        Sx.puts();
